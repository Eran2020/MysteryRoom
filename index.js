    ...
    if(ca == 2) {
       ...
       if(x>645&&y>138&&x<947&&y<700||x==0&&y==0){
           ...
           if(val==31401){
            ...
            document.getElementById("image-safe-cover").style.display = "none";
...
function showImg(item) {
    switch (item) {
        ...
        case "safe":
            ...
            document.getElementById("image-safe-cover").style.display = "block";
            break;
        case "combination":
            ...
            break;
        case 'yellow-book':
            document.getElementById("text").innerHTML = "Manual at Freddy's- How to repair damaged Animatronics!";
            break;
        case 'red-book':
            document.getElementById("text").innerHTML = "Freddy's Pizzaria Deed- This will make everyone happy!";
            break;
        case 'green-book':
            document.getElementById("text").innerHTML = "Self Defense 101- How to bring a gun to a knife fight."
            break;
        case 'pink-book':
            document.getElementById("text").innerHTML = "How to shoot a gun- You never know what's out there."
            break;
    }
}
